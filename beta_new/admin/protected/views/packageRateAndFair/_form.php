...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'rate',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'rate'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'available_date'); ?>
		<?php echo $form->textArea($model,'available_date',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'available_date'); ?>
	</div>
