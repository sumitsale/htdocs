											...
											<div class="th">
												...
												<div class="package_wrap black  lst">
													...
													<span class="packageContent">
														...
														'category'=>str_replace('&','and',str_replace(' ','-',strtolower($result['package_listing'][$i]['category_name']))),'name'=>strtolower(str_replace('&','and',str_replace(' ','-',$result['package_listing'][$i]['package_name']).'-'.str_replace(' ','',$result['package_listing'][$i]['package_night']).'-'.str_replace(' ','',$result['package_listing'][$i]['package_day']))))); ?>" title="View Detail">View Detail</a>
													</span>
												</div>
											...
											<div class="th">
												...
												<div class="package_wrap black lst">
													...
													<span class="packageContent">
														...
														<a href="<?php echo Yii::app()->createUrl('Water_spot/index'); ?>" title="View Detail">View Detail</a>
													</span>
												</div>
...
$( "#arrival_time" ).datepicker();
        ...
        <div class="testimonals-list">
		  ...
		  <?php for($te=0;$te<count($result['testimonial']);$te++) { ?>
           
    	   <li><span class="quote-top"><img alt="" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/ico_blackquote_two.png"></span>
              <p><?php echo $result['testimonial'][$te]['description']; ?>
			   <a href="<?php echo Yii::app()->createUrl('Testimonial/index'); ?>" class="test_read">Read More</a>
			  </p>
              <span class="quote-bottom"><img alt="" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/ico_blackquote_one.png"></span>
			  <strong>- <?php echo $result['testimonial'][$te]['name']; ?></strong>
			 </li>
