...
<html>
	<head>
		<title>MET Holiday: Testimonial</title>
				...
				<?php echo $content; ?>
					...
					<div class="advtWrap margin_top">
						<div class="advertise">
							...
							<a href="<?php echo Yii::app()->createUrl('packages/detail',array('id'=>$random_package[0]['package_id'])); ?>" class="grey" title="View Details">View Details</a>
					...
					<div class="advtWrap margin_top">
						<div class="advertise">
							...
							<a href="<?php echo Yii::app()->createUrl('Contact_us/index',array('id'=>$random_hotel[0]['hotel_id'],'type'=>"hotel")); ?>" class="red" title="ENQUIRE">ENQUIRE</a>
								<a href="<?php echo Yii::app()->createUrl('Hotels/detail',array('id'=>$random_hotel[0]['hotel_id'])); ?>" class="grey" title="View Details">View Details</a>
							<!--<a href="" class="grey" title="Book Online">Book Online</a>-->
						</div>
