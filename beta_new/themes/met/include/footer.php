<footer class="margin_top">
				...
				<div class="fotter">
					...
					<ul class="fotter-nav col-2">
						...
						<li><a href="<?php echo Yii::app()->createUrl('Places_to_visit/index',array('type'=>"Parks_and_Shopping_Points")); ?>">Location &amp; Area</a></li>
						<li><a href="<?php echo Yii::app()->createUrl('Places_to_visit/index',array('type'=>"Beaches")); ?>">Beaches at Andaman</a></li>
						<li><a href="<?php echo Yii::app()->createUrl('Places_to_visit/index',array('type'=>"Monuments-and-Museums")); ?>">Monuments at museums</a></li>
						<li><a href="<?php echo Yii::app()->createUrl('Places_to_visit/index',array('type'=>"Islands")); ?>">Island to Visit</a></li>
					</ul>
					<ul class="fotter-nav col-2">
						<h4>General Information</h4>
						<li><a href="<?php echo Yii::app()->createUrl('General_info/index'); ?>">How to reach</a></li>
