<?php $this->pageTitle =$lang[0]['LANGUAGE_TITLE']. " Singers | ".$lang[0]['LANGUAGE_TITLE']." Music India". " | Independent Artists"." - ". "ArtistAloud.com"; ?>

<?php Yii::app()->clientScript->registerMetaTag("Get all the information on ".$lang[0]['LANGUAGE_TITLE']." music artists, listen to ".$lang[0]['LANGUAGE_TITLE']. " songs and profiles only at ArtistAloud.com",'description'); ?>

<?php Yii::app()->clientScript->registerMetaTag($lang[0]['LANGUAGE_TITLE'] ." singers, independent music India, artists, artists in ".$lang[0]['LANGUAGE_TITLE'].", India, music, latest ".$lang[0]['LANGUAGE_TITLE']." music,".$lang[0]['LANGUAGE_TITLE']." music, exclusive, artist aloud, india, upload music free, independent <".$lang[0]['LANGUAGE_TITLE']."> music artists, artist languages, song languages, artistaloud",'keywords'); ?>
		...
		function link(cur)
		{
			...
			var dataString = 'currentPage='+ newValue;
										$.ajax({  
															type: "POST",
															async:false,															
															url: "<?php echo CController::createUrl("artist/ajaxLang");  ?>	",  
															data: dataString,															
...
<div class="content-left fl">
                ...
                <div class="breadcrumb grey99 fnt11">
								...
								<?php echo CHtml::link('Language Listing', CController::createUrl("artist/language"), array('class' => 'breadcrumb grey99 fnt11')); ?> &#x21d2;
								<?php echo $lang[0]['LANGUAGE_TITLE']; ?> Artists
								</div>
                
                <div class="page-title mt10">
                	<h2 class="page-title-block fl"><?php echo $lang[0]['LANGUAGE_TITLE']; ?> Artists</h2>
...
<ul class="blue">
    ...
    <li><a class="trigger-l current" title="languages"><span class="font-mole">languages</span></a></li>
    ...
    Click on the images to know more.
     ...
     <div class="clr"></div>
				...
				<div class="section-title"><?php echo $row['LANGUAGE_TITLE']; ?> Artists</div>
    ...
    <div class="cover boxcaption">
        ...
        <span class="rollover">
          ...
          <a href="javascript:;" url="<?php echo $songlist[$r]['songPath']; ?>" value="" file_id="<?php echo $songlist[$r]['fileId']; ?>" artist_id="<?php echo $artistfile->artistId; ?>" content_id="<?php echo $songlist[$r]['contentId']; ?>" class="play fl mt4">&nbsp;</a>
					<?php } ?>
					<span class="song-title pl15">
					<a href="javascript: void(0)" class="grey99"><?php 
