<div class="content-left fl">
                ...
                <div class="page-title mt10">
                	<h2 class="page-title-block fl">Language</h2>
...
<ul class="blue">
    ...
    <li><a class="current" title="languages" href="<?php echo Yii::app()->baseUrl;  ?>/index.php/languages/index"><span class="font-mole">languages</span></a></li>
    <li><a title="Genres" href="<?php echo Yii::app()->baseUrl;  ?>/index.php/genre/index"><span class="font-mole">genres</span></a></li>
</ul>
	...
	<div class="panal-content">
		...
		<div class="panal-list">
        	<ul class="each-list">
				...
				<div class="section-title"><?php echo $row['LANGUAGE_TITLE']; ?></div>
