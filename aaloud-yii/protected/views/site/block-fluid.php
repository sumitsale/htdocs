        ...
        <div class="n-desc fl">
          <?php 
					if(isset($newreleasesxml->album[$i]->artistName) && !(empty ($newreleasesxml->album[$i]->artistName)))
								...
								echo $artistname;
								} ?><span class="grey99 fnt11"><br />
            Song :		
						<?php if(isset($newreleasesxml->album[$i]->track) && !(empty ($newreleasesxml->album[$i]->track)))
										{
            ...
            Genre :		
						<?php if(isset($newreleasesxml->album[$i]->genre) && !(empty ($newreleasesxml->album[$i]->genre)))
										{
          ...
          <div class="upc-desc fl">
            <?php 
								$eventname = $events[$i]['event_name'];
												if(strlen($eventname)>20)
												{
												$eventname = substr($events[$i]['event_name'],0,18);
												$eventname.="...";
												}
												else
												{
            ...
            <?php 
								$location = $events[$i]['location'];
												...
												{
												$location = substr($events[$i]['location'],0,14);
												$location.="...";
												}
												else
												{
...
<div class="w250 fl mr20"> 
  ...
  <div class="block bg-white"><!--<img src="images/temp/fbtemp.gif" alt="fb" />-->
   ...
   <div class="fb-like-box" data-href="http://www.facebook.com/artistaloud" data-width="250" data-height="265" data-show-faces="false" data-border-color="#FFFFFF" data-stream="true" data-header="false"></div>
        ...
        <li><?php 
          ...
          <span class="grey99 mt5 block"><?php echo date('dS', $date) . " " . date('F', $date) . " " . date('y', $date); ?> | 
            <?php 
						...
						//echo $news[$i]['Press_News_Source']; ?></span>
        </li> 
