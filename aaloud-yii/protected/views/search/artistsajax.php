...
<div class="bottom-pagination mt10">
  ...
  if (!(empty($totalPage) > 1)) {
    ?>
    <ul id="pagination_bottom">
      <input type="hidden" id="hdn_pag" value="0">
      <input type="hidden" id="hdn_pag_last" value="2">
      <input type="hidden" id="hdn_max" value="<?php echo !(empty($totalPage)); ?>">
      <input type="hidden" id="hdn_lang" value="<?php echo !(empty($langId)); ?>">
      <li style="cursor:pointer;">&lt;&lt;</li>
      <?php
      for ($i = 1; $i <= !(empty($totalPage)); $i++) {
        ?>
