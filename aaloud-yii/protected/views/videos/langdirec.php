		...
		function link(cur)
		{
			...
			var dataString = 'currentPage='+ newValue;
										$.ajax({  
															type: "POST",
															async:false,															
															url: "<?php echo CController::createUrl("videos/ajaxLang");  ?>	",  
															data: dataString,															
...
<?php $this->pageTitle =$lang[0]['LANGUAGE_TITLE']." Music Videos |"." Independent Music | ".$lang[0]['LANGUAGE_TITLE']." Artists Videos"." - ArtistAloud.com";  ?>

<?php Yii::app()->clientScript->registerMetaTag("Watch all ".$lang[0]['LANGUAGE_TITLE']." music videos of different independent artists only at ArtistAloud.com a premium destination for independent songs and music by independent artists.",'description'); ?>
<?php Yii::app()->clientScript->registerMetaTag($lang[0]['LANGUAGE_TITLE']." videos, ".$lang[0]['LANGUAGE_TITLE']." music videos, independent artists, independent music, songs, songs videos, video languages, artist languages, watch free videos, artistaloud",'keywords'); ?>
...
<div class="content-left fl">
								...
								<?php echo CHtml::link('Language Listing', CController::createUrl("videos/langlist"), array('class' => 'breadcrumb grey99 fnt11')); ?> &#x21d2;
								<?php echo $lang[0]['LANGUAGE_TITLE']; ?> Videos
								</div>

    <div class="page-title mt10">
        <h2 class="page-title-block fl"><?php echo $lang[0]['LANGUAGE_TITLE']; ?> Videos</h2>
    ...
    <script type="text/javascript">
      ...
      //window.onload=playStream;
        ...
        <div class="page-title mt10">
            ...
            <h3 class="sub-page-title-block fl"><?php echo $row['LANGUAGE_TITLE']; ?> Videos</h3>
                           ...
                           <!-- <div class="new-button">
                            ...
                            <div class="vid-bottom">
                                <div class="play-button" style="cursor:pointer;" href="">
                                    <div style="cursor:pointer;" class="block" href=""></div>
                                </div>
                                <div class="name-list">
...
?>
    <ul id="pagination_bottom">
		...
		<input type="hidden" id="hdn_lang" value="<?php echo $langId; ?>">
