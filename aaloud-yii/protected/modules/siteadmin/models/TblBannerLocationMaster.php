...
/**
 * This is the model class for table "tbl_aa_banner_location_master".
 *
 * The followings are the available columns in table 'tbl_aa_banner_location_master':
...
class TblBannerLocationMaster extends CActiveRecord
{
	...
	{
		return 'tbl_aa_banner_location_master';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('LOCATION, BANNER_MODULE, BANNER_TITLE, BANNER_WIDTH, BANNER_HEIGHT', 'required'),
			array('BANNER_WIDTH,BANNER_HEIGHT', 'numerical', 'integerOnly'=>true),
			array('LOCATION', 'length', 'max'=>25),
			array('BANNER_MODULE, BANNER_TITLE, BANNER_WIDTH, BANNER_HEIGHT', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('LOCATION_ID, LOCATION, BANNER_MODULE, BANNER_TITLE, BANNER_WIDTH, BANNER_HEIGHT, CREATED, MODIFIED', 'safe', 'on'=>'search'),
		);
	}
