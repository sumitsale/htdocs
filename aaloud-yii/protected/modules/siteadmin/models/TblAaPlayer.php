...
/**
 * This is the model class for table "tbl_aa_player".
 *
 * The followings are the available columns in table 'tbl_aa_player':
 ...
 */
class TblAaPlayer extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TblAaPlayer the static model class
	 */
