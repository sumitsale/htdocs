...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var defaultVideoURL = '<?php echo CController::createUrl('video/displaySongMinorDetails'); ?>';
...
<table>
			...
			<td>
				...
				<?php 
						$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
										...
										'source'=>$this->createUrl('video/autocompleteTest'),			
										'options'=>array(
														'showAnim'=>'fold',
		...
		<tr>
			<td>Videos</td>
			<td>    
				<?php echo $form->dropDownList($model1,'CONTENT_TITLE', array() , array('prompt'=>'--No Videos--')); ?>
