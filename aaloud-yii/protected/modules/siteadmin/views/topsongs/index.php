...
$(document).ready(function() {
	...
	var dataString = 'dir='+ dir;
												...
												$.ajax({  
															type: "POST",  
															url: "<?php echo CController::createUrl("Topsongs/sort");  ?>	",  
															data: dataString,
...
echo $form->labelEx($model,'song_name'); ?>
<?php //echo $form->error($model,'student_name');
			...
			'source'=>$this->createUrl('Topsongs/autocompleteTest'),
           ...
           $('#label').val(ui.item.label);
            ...
            $('#call_code').val(ui.item.call_code);
						 $('#Topsongs_content_id').val(ui.item.id);
