...
<tr>
		...
		<td><?php echo $form->textField($model,'STORE_FRONT_ID',array('size'=>25,'value'=>'','maxlength'=>25)); ?>
		<?php echo $form->error($model,'STORE_FRONT_ID'); ?></td>
</tr>	

<tr>

		<td><?php echo $form->labelEx($model,'LOCATION_ID'); ?></td>
		<td><?php echo $form->dropDownList($model,'LOCATION_ID',CHtml::listData($country,'COUNTRY_ID','COUNTRY_NAME'),array('prompt'=>'select country')); ?>
