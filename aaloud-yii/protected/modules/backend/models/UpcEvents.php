...
class UpcEvents extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('artist_name, event_date, location, city', 'required'),
			array('artist_name, location, city', 'length', 'max'=>50),
			array('modified_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, artist_name, event_date, location, city, created_date, modified_date', 'safe', 'on'=>'search'),
		);
	}
