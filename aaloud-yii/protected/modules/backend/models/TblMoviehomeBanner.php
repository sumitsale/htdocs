...
/**
 * This is the model class for table "tbl_moviehome_banner".
 *
 * The followings are the available columns in table 'tbl_moviehome_banner':
 ...
 * @property string $url
 */
class TblMoviehomeBanner extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TblMoviehomeBanner the static model class
	 */
