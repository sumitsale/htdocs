...
class HomepageLeftBottomController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','addimage'),
				'users'=>array('admin'),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('HomepageLeftBottom');
	...
	{
		$model=new HomepageLeftBottom('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['HomepageLeftBottom']))
			$model->attributes=$_GET['HomepageLeftBottom'];
	...
	{
		$model=HomepageLeftBottom::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='homepage-left-bottom-form')
		{
