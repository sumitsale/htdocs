...
<link rel="stylesheet" id="wpmega-grey-white-css"  href="<?php echo Yii::app()->theme->baseUrl; ?>/css/menu/greywhite.css" type="text/css" media="all" />
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        $(document).delegate(".img-block", "click", imgover);
          ...
          $(document).undelegate(".img-block", "click", imgover);
					setTimeout( function(){
            $(document).delegate(".img-block", "click", imgover);
					}, 500 );
					return false;
...
jQuery.easing['BounceEaseOut'] = function(p, t, b, c, d) {
	...
	<script type="text/javascript" charset="utf-8">
			$(document).ready(function(){
				...
				$("a[rel^='t_and_c']").prettyPhoto({theme:'light_square', social_tools:false, deeplinking: false, slideshow: false, autoplay_slideshow: false, default_width: 560, default_height:365, show_title: false, modal: true, allow_resize: false});
...
<div class="side-in mt10">
						...
						$resultArr= 	Yii::app()->db2->createCommand()					
							...
							foreach($allartist as $index => $artistId){
								...
								$artistDetails = 	Yii::app()->db2->createCommand()
											...
											->queryAll();
							?>
							<?php if(isset($artistDetails[0]['image']) && $artistDetails[0]['image'] !='') { ?> 
								<li>
 ...
 <div id="bottom" class="fnt11">
    ...
    | <?php echo CHtml::link('Disclaimer', CController::createUrl("site/disclaimer"), array('class' => 'grey99')); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      ...
      | <a href="http://www.dailymotion.com/artistaloud" target="_blank" class="grey99">Dalilymotion</a></div>
  </div>
