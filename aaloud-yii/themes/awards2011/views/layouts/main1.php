 ...
 <li id="menu-item-186" class="menu-item menu-item-type-custom menu-item-object-custom ss-nav-menu-item-depth-1"><!--<a href="#"><span class="wpmega-link-title">Profile</span></a>--> <?php echo CHtml::link('Profile', CController::createUrl("profile/index"), array('class' => 'wpmega-link-title')); ?></li>
  ...
  <li id="menu-item-189" class="menu-item menu-item-type-custom menu-item-object-custom ss-nav-menu-item-depth-1"><!--<a href="#"><span class="wpmega-link-title">Settings</span></a>-->
																																										...
																																										->queryAll();
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <li class="detailsa pt10 pl5"><a href="#"><?php echo CHtml::link('More', CController::createUrl("artist/popularartist")); ?> </a></li>
                                                                                                                                                                                                        </ul>
                                                                                                                                                                                                        </li>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <ul class="sub-menu sub-menu-2">
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <li id="menu-item-86" class="menu-item menu-item-type-custom menu-item-object-custom ss-nav-menu-item-depth-2">
																																																																																																						<?php echo CHtml::link('' . $toplang[$i]['LANGUAGE_TITLE'], CController::createUrl("artist/languagedir?id=" . $toplang[$i]['LANGUAGE_ID']), array('class' => 'wpmega-link-title')); ?></li> <?php } ?>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <li class="detailsa pt10 pl5"><a href="#"><?php echo CHtml::link('All Languages', CController::createUrl("artist/language")); ?></a></li>
                                                                                                                                                                                                        </ul>
                                                                                                                                                                                                        </li>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <ul class="sub-menu sub-menu-2">
                                                                                                                                                                                                        <li class="detailsa pt10 pl5"><a href="#"><?php echo CHtml::link('All Genres', CController::createUrl("artist/genres")); ?></a></li>
                                                                                                                                                                                                        </ul> 
                                                                                                                                                                                                        </li>
																		...
																		<?php echo CHtml::link('' . $popularvideo->video[$i]->videoName, CController::createUrl("videos/index/"), array('class' => 'wpmega-link-title')); ?></span></li>
																					...
																					<?php echo CHtml::link('Z', array('videos/directory', 'char' => 'Z')); ?>
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <li class="detailsa pt10 pl5"><?php echo CHtml::link('All Genres', CController::createUrl("videos/genrelist")); ?></li>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <td><input type="radio" name="usertype" value="A"/>&nbsp; An Artist <input type="radio" name="usertype" value="L" checked="checked" /> A Listener</td>
                                                                                                                                                                                                        <td></td>
                                                                                                                                                                                                        <td>&nbsp;</td>
                                                                                                                                                                                                        </tr>
                                                                                                                                                                                                        <tr>
