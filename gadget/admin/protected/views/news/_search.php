...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'thumbnail_small'); ?>
		<?php echo $form->textField($model,'thumbnail_small',array('size'=>60,'maxlength'=>1000)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'thumbnail_big'); ?>
		<?php echo $form->textArea($model,'thumbnail_big',array('rows'=>6, 'cols'=>50)); ?>
	</div>
