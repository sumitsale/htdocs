...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row thumbnail_big_<?php echo ($i+1)?>">
		...
		<label><a target="_blank" href="<?php echo Yii::app()->baseurl.'../../images/news/big_thumbnail/'.$thumbnail_big_array[$i]; ?>"><?php echo $thumbnail_big_array[$i]; ?></a> - <span style="color: red;" onclick="remove_big_thumbnail(<?php echo $model->id; ?>,<?php echo $i;?>);">Remove</span></label>
	</div>
