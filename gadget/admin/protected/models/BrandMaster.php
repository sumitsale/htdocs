 ...
 *
 * The followings are the available columns in table 'brand_master':
 * @property integer $id
 * @property string $name
 * @property integer $date_added
 * @property integer $date_modified
 */
class BrandMaster extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, date_added, date_modified', 'required'),
			// array('date_added, date_modified', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, date_added, date_modified', 'safe', 'on'=>'search'),
		);
	}
