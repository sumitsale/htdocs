...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->labelEx($model,'start_hour'); ?>
		<?php // echo $form->textField($model,'start_time',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->dropDownList($model,'start_hour', $start_time, array('empty'=>'Select start hour'));?>
	...
	<?php echo $form->labelEx($model,'start_minute'); ?>
		<?php // echo $form->textField($model,'start_time',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->dropDownList($model,'start_minute', $start_minute, array('empty'=>'Select start minute'));?>
