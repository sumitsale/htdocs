								...
								<div class="panel-body">				
									<form class="form-inline">
										<div class="post col-md-7" >
											<label for="input-Default" class="col-sm-12 control-label">Enter the comments</label><br><br>
											...
											<div class="post-options">
												<button type="button" class="btn btn-danger btn-rounded cu-btn-rounded ">Send Back to Initiator</button>
												<button type="button" class="btn btn-success btn-rounded cu-btn-rounded ">Approve</button>
											</div>
										</div>
									</form>				
								</div>
