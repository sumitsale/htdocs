                	...
                	<div class="row">
                    	<div class="col-md-8" ng-controller="companyInfoController">
							...
							<form class="form-horizontal" style="margin-top:30px;" enctype="multipart/form-data" role="form" ng-submit="submit()" ng-fab-form-options="customFormOptions">
                                ...
                                <div class="col-md-2">
									<select class="form-control m-b-sm" id="document_status_1" name="document_status_1" ng-model="companyInfoModel.row1.document_status">
										<option value="1">Yes</option>
										<option value="0">No</option>
									</select>
                                </div>                              
                                <div class="col-sm-3" ng-show="companyInfoModel.row1.document_status==1">
									<span class="btn btn-success fileinput-button" onclick="showCompanyFileUploader('ISO 9001',1)" >
								...
								<div class="col-md-2">
                                    <label>ISO 14000</label>
                                </div>                                
                                <div class="col-md-2" >
									<select class="form-control m-b-sm" id="document_status_2" name="document_status_2" ng-model="companyInfoModel.row2.document_status">
										<option value="1">Yes</option>
										<option value="0">No</option>
									</select>
                                </div>
                                <div class="col-sm-3" ng-show="companyInfoModel.row2.document_status==1" >
									<span class="btn btn-success fileinput-button"  onclick="showCompanyFileUploader('ISO 14000',2)" >
										<i class="glyphicon glyphicon-plus"></i>
										<span>Add/View Documents</span>
									</span>
                                </div><br><br><br>
                                ...
                                <div class="col-md-2" >
									<select class="form-control m-b-sm" id="document_status_3" name="document_status_3" ng-model="companyInfoModel.row3.document_status">
										<option value="1">Yes</option>
										<option value="0">No</option>
									</select>
                                </div>                                
                                <div class="col-sm-3"  ng-show="companyInfoModel.row3.document_status==1">                                 	
									<span class="btn btn-success fileinput-button" onclick="showCompanyFileUploader('OHSAS',3)">
										<i class="glyphicon glyphicon-plus"></i>
										<span>Add/View Documents</span>
									</span>
                                </div><br><br><br>
                                ...
                                <div class="col-md-2">
                                    <label>ISO 27000</label>
                                </div>                                
                                <div class="col-md-2">
									<select class="form-control m-b-sm" id="document_status_4" name="document_status_4" ng-model="companyInfoModel.row4.document_status">
										<option value="1">Yes</option>
										<option value="0">No</option>
									</select>
                                </div>                                
                                <div class="col-sm-3"  ng-show="companyInfoModel.row4.document_status==1">
                                 	    <span class="btn btn-success fileinput-button" onclick="showCompanyFileUploader('ISO 27000',4)">
											<i class="glyphicon glyphicon-plus"></i>
											<span>Add/View Documents</span>
                                        </span>
                                </div><br><br><br>
                                ...
                                <div class="col-md-2">
									<select class="form-control m-b-sm" id="document_status_6" name="document_status_4" ng-model="companyInfoModel.row6.document_status">
										<option value="1">Yes</option>
										<option value="0">No</option>
									</select>
                                </div>                                
                                <div class="col-sm-3"  ng-show="companyInfoModel.row6.document_status==1">
									<span class="btn btn-success fileinput-button" onclick="showCompanyFileUploader('IBR',6)">
										<i class="glyphicon glyphicon-plus"></i>
										<span>Add/View Documents</span>
									</span>
                                </div><br><br><br>
                                ...
                                <div class="col-md-2">
									<select class="form-control m-b-sm" id="document_status_7" name="document_status_7" ng-model="companyInfoModel.row7.document_status">
										<option value="1">Yes</option>
										<option value="0">No</option>
									</select>
                                </div>
                                <div class="col-sm-3"  ng-show="companyInfoModel.row7.document_status==1">
                                        <span class="btn btn-success fileinput-button" onclick="showCompanyFileUploader('CE',7)">
                                        <i class="glyphicon glyphicon-plus"></i>
                                        <span>Add/View Documents</span>
                                        </span>
                                 </div><br><br><br>
                                ...
                                <div class="col-md-2">
									<select class="form-control m-b-sm" id="document_status_8" name="document_status_4" ng-model="companyInfoModel.row8.document_status">
										 <option value="1">Yes</option>
										<option value="0">No</option>
									</select>
                                </div>                                
                                <div class="col-sm-3"  ng-show="companyInfoModel.row8.document_status==1">
                                        <span class="btn btn-success fileinput-button" onclick="showCompanyFileUploader('UL',8)">
                                        <i class="glyphicon glyphicon-plus"></i>
                                        <span>Add/View Documents</span>
                                        </span>
                                </div><br><br><br>
                                ...
                                <div class="col-md-2">
                                <select class="form-control m-b-sm" id="document_status_9" name="document_status_4" ng-model="companyInfoModel.row9.document_status">
                                     <option value="1">Yes</option>
                                    <option value="0">No</option>
                                </select>
                                </div>                                
                                 <div class="col-sm-3"  ng-show="companyInfoModel.row9.document_status==1">
                                        <span class="btn btn-success fileinput-button" onclick="showCompanyFileUploader('ATEX',9)">
                                        <i class="glyphicon glyphicon-plus"></i>
                                        <span>Add/View Documents</span>
                                        </span>
                                 </div><br><br><br>
                                ...
                                <div class="col-md-2">
									<select class="form-control m-b-sm" id="document_status_5" name="document_status_5" ng-model="companyInfoModel.row5.document_status">
										<option value="1">Yes</option>
										<option value="0">No</option>
									</select>
                                </div>
                                <div class="col-sm-3" id="document_btn_5"  ng-show="companyInfoModel.row5.document_status==1">
                                 	<span class="btn btn-success fileinput-button" onclick="showCompanyFileUploader('Legal Cases',5)">
                                        <i class="glyphicon glyphicon-plus"></i>
                                        <span>Add/View Documents</span>
                                    </span>
                                </div>
