		...
		<main class="page-content content-wrap">
			...
			<div class="page-inner">
				<div class="page-title">
					<h3>View Applications -> Vendors Response</h3>
				</div>
				<div id="main-wrapper">
					<div class="row">
						<div class="col-md-12">
				...
				<div class="panel-body">				
					<form class="form-inline">
						<div class="post col-md-7" >
							<label for="input-Default" class="col-sm-12 control-label">Comments received from vendor:</label><br><br>
							<textarea class="form-control" placeholder="Comments" rows="4" style="width:100%;margin-left:15px" readonly>Updated the application and added the attachment as requested</textarea>
						</div>
					</form>				
				</div>
			</div>
		...
		<div class="col-md-12">
			<div class="panel panel-white">
				<div class="panel-body">				
					<form class="form-inline">
						<div class="post col-md-7" >
							<label for="input-Default" class="col-sm-12 control-label">Respond to comments:</label><br><br>
							<textarea class="form-control" placeholder="Comments" rows="4=12" style="width:100%;margin-left:15px"></textarea>
							<div class="post-options">
								<button type="button" class="btn btn-danger btn-rounded cu-btn-rounded ">Send Back to Vendor</button>
								<button type="button" class="btn btn-danger btn-rounded cu-btn-rounded ">Send For Approval</button>
							</div>
						</div>
					</form>				
				</div>
